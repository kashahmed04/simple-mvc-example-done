...
const router = (app) => {
  ...
  // do we need a /* for POST requests too or only GET and HEAD requests
  // (we could do it for POST but it is only
  // for changing state)
  // do we only use GET and POST requests or can we do other requests as well
  // (all the other requests are there as well)
};
